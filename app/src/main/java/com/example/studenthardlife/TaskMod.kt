...
class TaskMod(private val dbHandler: DBHandler) : RecyclerView.Adapter<TaskMod.TaskViewHolder>() {
        ...
        RecyclerView.ViewHolder(itemView) {
            ...
            fun bind(item: Task){
                ...
                itemView.setOnClickListener {
                    val action = TaskRundownFragmentDirections.actionTaskOverviewFragmentToTaskDetailsFragment(taskId = item.id.toString())
