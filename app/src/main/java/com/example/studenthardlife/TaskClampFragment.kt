...
class TaskClampFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if(context != null) {
            ...
            binding.deleteTaskButton.setOnClickListener { dbHandler.deleteTask(task)
                Navigation.findNavController(binding.root).navigate(R.id.action_taskDetailsFragment_to_taskOverviewFragment) }
            binding.editTaskButton.setOnClickListener { setupDialog(task) }
